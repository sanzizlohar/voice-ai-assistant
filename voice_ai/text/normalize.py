...
LANGUAGES: dict[str, Language] = {
    "en": Language(
        ...
        responses={
            ...
            "help": ["You can ask for the time, weather, math, notes or a timer."],
    ...
    "hi": Language(
        ...
        responses={
            ...
            "help": ["आप समय, मौसम, नोट या टाइमर पूछ सकते हैं।"],
            "thanks": ["कोई बात नहीं!"],
    ...
    "bn": Language(
        ...
        responses={
            ...
            "help": ["আপনি সময়, আবহাওয়া, নোট বা টাইমার জিজ্ঞাসা করতে পারেন।"],
            "thanks": ["স্বাগতম!"],
